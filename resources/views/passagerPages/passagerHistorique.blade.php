                        ...
                        <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                            ...
                            <div class="media-body ">
                                ...
                                <ul class="list-inline list-inline-dotted mb-3 mb-lg-2">
                                    <li class="list-inline-item"><p href="#" class="text-muted" data-abc="true">date Reservation</p></li>
                                </ul>
                            ...
                            <div class="mt-3 mt-lg-0 ml-lg-3 text-center" style=" width: 250px">
                                ...
                                <span> 4,5</span>
                                <p type="button" class="btn btn-success mt-4 text-white"><i class="icon-cart-add mr-2"></i>merci pour votre confiuns</p>
