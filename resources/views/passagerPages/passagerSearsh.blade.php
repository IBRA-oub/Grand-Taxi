                        ...
                        <div class="card card-body mt-3 shadow">
                                <div class="media align-items-center align-items-lg-start text-center text-lg-left flex-column flex-lg-row">
                                    <div class="mr-2 mb-3 mb-lg-0">
                                            ...
                                            <img src="{{asset('storage/image/' .auth()->user()->picture)}}" width="170" height="160" alt="" class="rounded">
                                       
                                    </div>
        
                                    <div class="media-body ">
                                        <h6 class="media-title font-weight-semibold">
                                            <p href="#" data-abc="true">Name : <strong>ayoub chaabat</strong></p>
                                            <p href="#" data-abc="true">type voiture : <strong> grand ford</strong></p>
                                    ...
                                    <div class="mt-3 mt-lg-0 ml-lg-3 text-center" style=" width: 250px">
                                        ...
                                        <a type="button" class="btn btn-success mt-4 text-white"><i class="icon-cart-add mr-2"></i>reservation</a>
